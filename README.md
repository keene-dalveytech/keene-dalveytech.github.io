...
//      const img  = "https://res.cloudinary.com/gmx/image/upload/gmx/chdkbi8l5nu210s9rh8g.jpg";
//     //  const img  = `https://ipfs.io/ipfs/${cid}`;
//     // const img ='https://gmx.io/static/media/logo_GMX.b956aa96.svg'
